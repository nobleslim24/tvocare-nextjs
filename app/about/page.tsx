  ...
  const team = [
    {
      ...
      img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=250&h=280",
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=250&h=280",
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&q=80&w=250&h=280",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 w-full">
              <div className="relative w-full h-[320px] bg-black-rich border border-black-border overflow-hidden rounded-[15px]">
                <Image 
                  src="/about-intro.jpg" 
                  alt="Who We Are - TVO Care" 
                  fill
                  className="object-cover" 
                  sizes="(max-w-768px) 100vw, 33vw"
                />
                <div className="absolute inset-0 border border-gold-500/10 rounded-[15px]"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black-pure border-b border-black-border relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((member, i) => (
              <div key={i} className="bg-black-rich border border-black-border rounded-[20px] overflow-hidden group">
                <div className="h-[280px] overflow-hidden bg-black-pure relative border-b border-black-border">
                  <Image 
                    src={member.img} 
                    alt={member.name} 
                    fill
